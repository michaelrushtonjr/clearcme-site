...
export function BrandLockup({
  ...
  const inner = (
    <span className={clsx("inline-flex items-center", gap, className)}>
      ...
      >
        {/* Cream tile — load-bearing on dark surfaces (terracotta mark alone
            measures 2.58:1 on forest, 4.76:1 inside the tile). Light surfaces
            get the transparent mark directly on canvas. */}
        {dark && (

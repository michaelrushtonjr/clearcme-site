...
const doRenewalRules: Partial<Record<StateCode, RenewalRuleConfig>> = {
  ...
  ME: birthBasedRenewal("Last day of your birth month, every 2 years (02-383 C.M.R. ch. 19 §3)"),
...
const mdRequirements: Record<StateCode, RequirementSeed> = {
  ...
  AL: {
    ...
    mandatoryTopics: [
      ...
      topic("Collaborative/supervisory practice CME", "Board course every 48 months", "If in a collaborative CRNP/CNM or supervisory PA arrangement; recurring every 48 months following commencement (540-X-8-.04(6) for CRNP/CNM collaboration; 540-X-7-.17(3),(5) for PA supervision); new arrangements: course taken not more than 48 months before or within 12 months of commencement; the 60-month look-back was a one-time transitional accommodation for the extended Jan. 1, 2025 compliance date"),
  ...
  ND: {
    ...
    cycleLabel: "2-year renewal cycle",
    mandatoryTopics: [
      topic("Nutrition and metabolic health", "1 hr per renewal cycle", "In force since Jan. 23, 2026 (SB 2401, special session)"),
  ...
  PA: {
    ...
    mandatoryTopics: [
      ...
      topic("Organ and tissue donation / recovery", "2 hrs one-time", "In effect since May 1, 2026; deadline depends on license date — licensed before May 1, 2026: within 5 years of licensure renewal; licensed on or after: within 5 years of initial licensure; reactivated on or after: within 5 years of reactivation (49 Pa. Code 16.19(c)(1))"),
      mateTopic(),
    ],
  },
  RI: {
    ...
    totalHoursLabel: "40 hours",
    cycleYears: 2,
    cycleLabel: "2-year renewal cycle; 216-RICR-40-05-1 §1.5.5 allows any ACCME-accredited topic area",
    mandatoryTopics: [
  ...
  TX: {
    ...
    mandatoryTopics: [
      ...
      topic("Safe prescribing / pain management", "2 hrs front-loaded, then every 8 years", "2 hrs in each of the first two renewal periods after initial licensure (with 2 of those hours completed by the first anniversary of licensure), then 2 hrs every 8 years (Occ. Code 156.055); direct patient care"),
      ...
      topic("Nutrition and metabolic health", "Hours to be set by TMB rule", "Effective for renewal applications filed on or after Jan. 1, 2027 (SB 25, 2025; Occ. Code 156.061) — not yet in force; TMB must adopt implementing rules by Dec. 31, 2026 prescribing the hours and content, based on the Texas Nutrition Advisory Committee's guidelines"),
...
const doOverrides: Partial<Record<StateCode, RequirementSeed>> = {
  ...
  PA: {
    ...
    mandatoryTopics: [
      ...
      topic("Initial opioid education", "4 hrs one-time", "Within 12 months after initial licensure/certification if authorized to prescribe or dispense"),
      topic("Organ and tissue donation / recovery", "2 hrs one-time", "In effect since May 1, 2026; deadline depends on license date — licensed before May 1, 2026: within 5 years of licensure renewal; licensed on or after: within 5 years of initial licensure; reactivated on or after: within 5 years of reactivation (49 Pa. Code 25.271(c)(6)(i))"),
      mateTopic(),
    ],
  },
  TN: {

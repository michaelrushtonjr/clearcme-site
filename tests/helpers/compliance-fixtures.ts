...
export function certificate(data: Partial<EngineCertificate> = {}): EngineCertificate {
  return { id: "certificate", title: "Clinical ethics", topics: ["ethics"], creditHours: 1, activityDate: new Date("2026-01-15"), extractionStatus: "COMPLETED", creditType: "AMA_PRA_1", accreditation: null, specialTopics: ["ETHICS"], manuallyVerified: false, ...data };
}

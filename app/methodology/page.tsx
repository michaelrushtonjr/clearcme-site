  ...
  return (
    <PublicShell links={[{ href: "/pricing", label: "Pricing" }, { href: "/mate-act", label: "DEA MATE Act" }]}> 
      ...
      <section className="mx-auto max-w-3xl space-y-8 px-6 pb-16">
        <div className="public-card p-6"><h2 className="text-xl font-bold mb-3">Published guides and product coverage</h2><p className="leading-7">Read the <Link className="underline" href="/cme-requirements">state guides</Link> for page-specific verification dates and sources. Physician author: <Link className="underline" href="/about/michael-rushton">Michael Rushton, DO</Link>. Source verification does not mean every exception or transition is personalized by the product; each guide states its relevant calculation limits.</p><p className="mt-4 leading-7">We review significant requirement changes against official sources and explain how they affect your renewal planning. Related course links help you find options; confirm that an activity meets your board’s specific requirements before enrolling.</p></div>
        <div className="public-card p-6">
          <h2 className="mb-3 text-xl font-bold">Physician editorial responsibility</h2>
          <p className="text-sm leading-relaxed"><Link href="/about/michael-rushton" className="underline">Michael Rushton, DO</Link>, ClearCME’s physician founder, authors these guides. Each guide shows when its sources were last checked and explains any situations the tracker does not yet fully account for. You remain responsible for completing your board’s official reporting process.</p>

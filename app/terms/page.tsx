    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-700">
          ...
          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">6. Subscriptions, Billing, and Refunds</h2>
            ...
            <p className="mt-2">If ClearCME does not work as expected, contact us within 14 days of purchase at <a href="mailto:hello@clearcme.ai" className="text-blue-600 hover:underline">hello@clearcme.ai</a>. We will either help resolve the issue or provide a reasonable refund when appropriate. Refunds are not guaranteed for accounts that have materially used export, reporting, or compliance-analysis features, but we will handle early-launch issues in good faith.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-slate-900 mb-3">7. Support</h2>
            <p>Support is available by email at <a href="mailto:hello@clearcme.ai" className="text-blue-600 hover:underline">hello@clearcme.ai</a>. We aim to respond promptly, but support communications do not create a physician-patient, attorney-client, or regulatory-advisory relationship.</p>
          </section>
          ...
          <section>
            ...
            <p>Questions about these Terms, billing, or support? Contact us at <a href="mailto:hello@clearcme.ai" className="text-blue-600 hover:underline">hello@clearcme.ai</a>.</p>
          </section>
